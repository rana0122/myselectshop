...
public class ProductService {
    ...
    public Page<ProductResponseDto> getProductsInFolder(Long folderId, int page, int size, String sortBy,
        ...
        Page<Product> productPage =productRepository.findAllByUserAndProductFolders_FolderId(user, folderId, pageable);
...
//        List<Product> productsList = productRepository.findAll(); //.var 단축키
//        List<ProductResponseDto> responseDtoList = new ArrayList<>();
//
//        for (Product product : productsList) { //iter 단축키
